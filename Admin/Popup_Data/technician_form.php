<form action="Controller/TehnicianController.php" method="post" enctype="multipart/form-data">
<div class="form-group">
  ...
  <div class="form-group">
    <label for="">Technician Usernmae:</label>
    <input type="text" name="tech_username" style="border:1px solid;" class="form-control" id="email">
  </div>
  <div class="form-group">
    <label for="">Technician Password:</label>
    <input type="text" name="tech_password" style="border:1px solid;" class="form-control" id="email">
  </div>
  <div class="form-group">
