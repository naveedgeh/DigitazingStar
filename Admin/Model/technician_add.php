...
if (isset($_POST['add_technician'])) {
           ...
           $tech_username=$_REQUEST['tech_username'];
           $tech_password=$_REQUEST['tech_password'];
...
// Check if $uploadOk is set to 0 by an error
      ...
      $sql = "INSERT INTO `technician_tb` (`name`, `phone`, `email`,`tech_username`,`tech_password` ,`image`)
       VALUES ('$name','$phone','$email','$tech_username','$tech_password','$tech_img')";
